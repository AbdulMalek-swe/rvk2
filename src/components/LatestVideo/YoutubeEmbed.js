...
const YoutubeEmbed = ({ embedId }) => {
  ...
  <div className="video-responsive" >
   ...
   <img alt="loading ..." src={embedId.thumbnail}    style={{width:"100%",height:"350px",borderRadius:'12px'}}/>
    <>
      <Button onClick={() => setVisible(true)} style={{border:"none",color:"red",fontSize:"62px",background:"tranparent !important", position:"absolute",top:"30%",left:'35%'}}> <ImYoutube/> </Button>
